...
{
    scope=2;
    displayName="[FIR] GBU-55 LJDAM x1";
    displayNameShort="GBU-55 JDAM";
    descriptionShort="GPS/Laser Guided Bomb (1000-lbs)";
    displayNameMFDFormat="GBU-55";
    hardpoints[]=
    {
        #include "\CE_Aviation_Munitions\CE_Aviation_Munitions\Data\zHardpoints\Bomb_1000lbs_GPS_Hardpoints.hpp"
...
class FIR_gbu55_F15SE_P_1rnd_M: FIR_GBU55_P_1rnd_M
{
    scope=2;
    displayName="[FIR] GBU-55 LJDAM x1";
    displayNameShort="GBU-55 JDAM";
...
class FIR_gbu55_P_EWP_1rnd_M: FIR_GBU55_P_1rnd_M
{
    scope=2;
    displayName="[FIR] GBU-55 LJDAM x1 (Enlosed Pod)";
    displayNameShort="GBU-55 JDAM";
    descriptionShort="GPS/Laser Guided Bomb (1000-lbs)";
    displayNameMFDFormat="GBU-55";
    hardpoints[]=
...
class FIR_GBU55_Navy_P_1rnd_M: FIR_GBU55_P_1rnd_M
{
    scope=2;
    displayName="[FIR] GBU-55 LJDAM (Navy) x1";
    displayNameShort="GBU-55 JDAM";
    descriptionShort="GPS/Laser Guided Bomb [US Navy] (1000-lbs)";
    displayNameMFDFormat="GBU-55";
    hardpoints[]=
    {
...
class FIR_gbu55_Navy_P_2rnd_M: FIR_GBU55_Navy_P_1rnd_M
{
    scope=2;
    displayName="[FIR] GBU-55 LJDAM (Navy) x2";
    displayNameShort="GBU-55 JDAM";
    descriptionShort="GPS/Laser Guided Bomb [US Navy] (1000-lbs)";
    displayNameMFDFormat="GBU-55";
    hardpoints[]=
...
class FIR_gbu55_Navy_EWP_1rnd_M: FIR_GBU55_Navy_P_1rnd_M
{
    scope=2;
    displayName="[FIR] GBU-55 LJDAM (Navy) x1 (Enlosed Pod)";
    displayNameShort="GBU-55 JDAM";
    descriptionShort="GPS/Laser Guided Bomb [US Navy] (1000-lbs)";
    displayNameMFDFormat="GBU-55";
    hardpoints[]=
